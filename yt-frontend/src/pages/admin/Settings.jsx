...
export default function AdminSettings() {
  ...
  const handlePasswordChange = async (e) => {
    ...
    setPwSaving(true);
    try {
      await changeAdminPassword({ currentPassword: pw.currentPassword, newPassword: pw.newPassword });
        ...
        <div className="as-card">
          ...
          <div className="as-info-list">
            ...
            <div className="as-info-row">
              ...
              <div className="as-info-row-body">
                <span>Role</span>
                <strong style={{ textTransform: "capitalize" }}>{profile?.role || "admin"}</strong>
              </div>
            </div>

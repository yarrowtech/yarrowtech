        ...
        <div className="contact-grid">
          <div className="contact-info slide-up delay-3">
            <div className="contact-info-panel">
              ...
              <h3>Start your project conversation with Yarrowtech</h3>
              <p className="contact-description">
                Website, ERP, mobile app, or custom software - we'll help you plan and
                deliver it.
              </p>
              ...
              <div className="contact-highlights">
                ...
                <div className="contact-highlight">
                  <strong>Expert guidance</strong>
                  <span>Right service for your goals</span>
                </div>
              </div>
            </div>
          ...
          <form className="contact-form slide-up delay-4" onSubmit={handleSubmit} noValidate>
            <div className="form-header">
              ...
              <h3>Tell us what you need</h3>
              <p>
                Fill out the form and we&apos;ll connect you with the right person.
              </p>
            </div>
